...
public class LinkBehavior { // is behavior a good name? it has a presentation part as well...
    ...
    private final LinkListener<Object> linkListener;
     ...
     */
    public LinkBehavior(@NotNull String linkText, @NotNull LinkListener<Object> linkListener, @Nullable Object data) {
    ...
    public LinkListener<Object> getLinkListener() {
        return linkListener;
    }
